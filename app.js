...
app.get('/get-users-posts:id', (req, res) => {
...
app.post('/create-post', bodyParser.json(), (req, res) => {
    ...
    fs.readFile(postsFilePath, 'utf8', (err, data) => {
        ...
        const newPost = { id: nextId, title, author, authorId, content };
        posts.push(newPost);
        ...
        fs.writeFile(postsFilePath, JSON.stringify(posts, null, 2), (err) => {
            ...
            res.json({ message: 'упех!', post: newPost });
        });
    });
});
    ...
    fs.readFile(postsFilePath, 'utf8', (err, data) => {
        ...
        if (postIndex !== -1) {
            ...
            fs.writeFile(postsFilePath, JSON.stringify(posts, null, 2), (err) => {
                ...
                res.json({ message: 'успех измена!', post: posts[postIndex], redirectUrl: urlRed });
            });
        } else {
            res.status(404).json({ message: 'Post not found.' });
        }
